...
@Api(allMethods = true)
@Export
public interface JsFeaturesSupported extends JsLayer, Exportable {
	 ...
	 */
	boolean selectFeature(JsFeature feature);
	 ...
	 */
	boolean deselectFeature(JsFeature feature);
