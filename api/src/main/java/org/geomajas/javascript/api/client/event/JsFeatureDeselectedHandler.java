...
@Api(allMethods = true)
@UserImplemented
public interface JsFeatureDeselectedHandler extends JsHandler, Exportable {

	/**
	 * Called when feature is deselected.
	 *
	 * @param event
	 *            {@link JsFeatureDeselectedEvent}
	 */
	void onFeatureDeselected(JsFeatureDeselectedEvent event);
}