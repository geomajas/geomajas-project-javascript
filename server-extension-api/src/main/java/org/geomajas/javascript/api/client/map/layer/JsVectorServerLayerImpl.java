 ...
 */
public class JsVectorServerLayerImpl extends org.geomajas.gwt2.client.map.layer
		.AbstractServerLayer<ClientVectorLayerInfo> implements org.geomajas.gwt2.client.map.layer.VectorServerLayer {
	...
	public JsVectorServerLayerImpl(ClientVectorLayerInfo layerInfo, final ViewPort viewPort, MapEventBus eventBus) {
		...
		this.renderer = new FixedScaleLayerRenderer(viewPort, this, eventBus) {
			...
			public FixedScaleRenderer createNewScaleRenderer(int tileLevel, View view, HtmlContainer scaleContainer) {
				return new VectorServerLayerScaleRenderer(JsVectorServerLayerImpl.this, tileLevel,
	...
	// ------------------------------------------------------------------------
	// JsVectorServerLayer implementation:
	// ------------------------------------------------------------------------
		...
		GwtCommandDispatcher.getInstance().execute(commandRequest,
				new AbstractCommandCallback<RegisterNamedStyleInfoResponse>() {
					...
					public void execute(RegisterNamedStyleInfoResponse response) {
						...
						eventBus.fireEvent(new LayerStyleChangedEvent(JsVectorServerLayerImpl.this));
					}
				});
	}
