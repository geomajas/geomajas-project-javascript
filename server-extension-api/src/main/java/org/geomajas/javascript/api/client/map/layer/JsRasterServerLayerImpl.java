 ...
 */
public class JsRasterServerLayerImpl extends org.geomajas.gwt2.client.map.layer
		.AbstractServerLayer<ClientRasterLayerInfo> implements org.geomajas.gwt2.client.map.layer.RasterServerLayer {

	private final FixedScaleLayerRenderer renderer;

	/** The only constructor. */
	public JsRasterServerLayerImpl(ClientRasterLayerInfo layerInfo, final ViewPort viewPort, MapEventBus eventBus) {
		...
		renderer = new FixedScaleLayerRenderer(viewPort, this, eventBus) {
			...
			public FixedScaleRenderer createNewScaleRenderer(int tileLevel, View view, HtmlContainer scaleContainer) {
				return new RasterServerLayerScaleRenderer(JsRasterServerLayerImpl.this, tileLevel,
