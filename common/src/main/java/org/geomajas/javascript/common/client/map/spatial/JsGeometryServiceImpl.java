...
public class JsGeometryServiceImpl implements JsGeometryService, Exportable {

	public JsGeometryServiceImpl() {
	}
	...
	public Bbox getBounds(Geometry geometry) {
		return org.geomajas.geometry.service.GeometryService.getBounds(geometry);
	}
