...
public class JsFeatureImpl implements Exportable, JsFeature {

	private org.geomajas.gwt2.client.map.feature.Feature feature;

	private JsFeaturesSupported layer;

	public JsFeatureImpl() {
	}

	public JsFeatureImpl(org.geomajas.gwt2.client.map.feature.Feature feature, JsFeaturesSupported layer) {
	 ...
	 */
	public JsFeaturesSupported getLayer() {
		return layer;
	}
	...
	public static org.geomajas.gwt2.client.map.feature.Feature toGwt(JsFeature feature) {
		return ((JsFeatureImpl) feature).feature;
	}
}